...
<div class="widget mg0 form_load" id="main_popup">
	...
	<div class="body">
			...
			<div class="left mt5 "  style='margin-left:5px;'>
			    <div>
			    <a style="color:indianred" target='_blank' href='<?php echo $row->product->_url_view; ?>' title='<?php echo $row->product->name; ?>'>
				...
				<div class="left dInline">
					...
					<div class='action'>
					   ...
					   <?php endif; ?>
						...
						<a href="<?php echo $row->_url_completed; ?>" class="button blueB mr5">
