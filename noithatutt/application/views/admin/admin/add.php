			...
			<form class="form" id="form" action="" method="post" enctype="multipart/form-data">
				<fieldset>
					...
					<div class="formRow">
						...
						<div class="formRight">
							<span class="oneTwo">
								<input name="name" id="param_name" _autocheck="true" type="text" placeholder="Nhập họ và tên của admin" value="<?php echo set_value('name')?>"/></span>
					...
					<div class="formRow">
						...
						<div class="formRight">
							<span class="oneTwo">
								<input name="username" id="param_username" _autocheck="true" type="text" placeholder="Nhập tài khoản mới" value="<?php echo set_value('username')?>"/></span>
							<span name="name_autocheck" class="autocheck"></span>
					...
					<div class="formRow">
						...
						<div class="formRight">
							<?php foreach ($config_permissions as $controllers =>$actions):?>
							 ...
							 <div>  <?php foreach ($actions as $action):?>
										<div style="text-align: left; margin-right: initial;">
											<input type="checkbox" name="permissions[<?php echo $controllers?>][]" value="<?php echo $action?>"/>
										<?php echo $action?> </div>
									<?php endforeach;?>
									</div>		
							<?php endforeach;?>
