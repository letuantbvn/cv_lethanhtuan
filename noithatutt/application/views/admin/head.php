<!--Quản lý phần head trong trang login -->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />

<title>Admin - Nội Thất UTT</title>
<link rel="shortcut icon" type="image/png" href="<?php echo public_url()?>admin/images/iconadmin.png"/>
...
<link rel="stylesheet" type="text/css" href="<?php echo public_url('admin')?>/css/bootstrap.min.css" media="screen" />
<link rel="stylesheet" type="text/css" href="<?php echo public_url('admin')?>/css/dashboard.css" media="screen" />
