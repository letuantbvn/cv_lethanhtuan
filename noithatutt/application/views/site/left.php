...
<div class="box-left">
	<div class="title tittle-box-left">
		<h2 style="font-size: 16px; color: #198fc4; margin-top:10px"> TÌM KIẾM THEO GIÁ </h2>
	</div>
	<div class="content-box"><!-- The content-box -->
		<form class="t-form form_action" method="get" style="padding:10px" action="<?php echo site_url('product/search_price')?>" name="search">
			...
			<div class="form-row">
				<label for="param_price_from" class="form-label" style="width:70px;font-size: 14px; font-family: Roboto;"><b>Giá từ:<span class="req">*</span></b></label>
			...
			<div class="form-row">
				<label for="param_price_from" class="form-label" style="width:70px; font-size: 14px"><b>Giá tới:<span class="req">*</span></b></label>
				<div class="form-item" style="width:90px">
			...
			<div class="form-row">
				...
				<div class="form-item">
					<input class="search-price" name="search" value="TÌM KIẾM" type="submit">
				</div>
				<div class="clear"></div>
			</div>
		</form>
...
<div class="box-left">
	<div class="title tittle-box-left">
		<h2 style="font-size: 15px; color: #198fc4; margin-top:10px"> DANH MỤC SẢN PHẨM </h2>
	</div>
	<div class="content-box"><!-- The content-box -->
