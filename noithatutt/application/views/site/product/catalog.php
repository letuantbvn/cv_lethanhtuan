...
<div class="box-center"><!-- The box-center product-->
	<div class="tittle-box-center">
		<h2 style="font-size: 16px; color: #337ab8; margin-top:6px"><?php echo $catalog->name?> (Có <?php echo $total_rows?> sản phẩm)</h2>
	</div>
	<div class="box-content-center product" style="magrin-top: 20px"><!-- The box-content-center -->
