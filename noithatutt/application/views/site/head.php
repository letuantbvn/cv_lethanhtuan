        ...
        <link type="text/css" href="<?php echo public_url()?>site/css/bootstrap.min.css" rel="stylesheet">
        <link type="text/css" href="<?php echo public_url()?>site/css/dashboard.css" rel="stylesheet">
        <link type="text/css" href="<?php echo public_url()?>site/css/all.css" rel="stylesheet">
        <link type="text/css" href="<?php echo public_url()?>site/css/ionicons.min.css" rel="stylesheet">
        <!-- End CSS: Kết thúc CSS-->
		
        <!-- the Javascript: Link dẫn JS -->

        <script src="//e.dtscout.com/e/?v=1a&amp;pid=5200&amp;site=1&amp;l=file%3A%2F%2F%2FC%3A%2FUsers%2Fletha%2FDesktop%2Ftemplate%2Fsite%2Findex.html&amp;j=" async="" type="text/javascript"></script><script type="text/javascript" src="<?php echo public_url()?>/js/jquery/jquery.min.js"></script>
		...
		#back_to_top {
		    ...
		    width: auto;
		        ...
		        <title>NỘI THẤT UTT</title>
				<link rel="shortcut icon" type="image/ico" href="<?php echo public_url()?>site/images/logomini.ico"/>
