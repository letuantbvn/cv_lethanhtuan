(function ($)
{
    ...
    var q = 
    {
        vertical : false, start : 1, offset : 1, size : null, scroll : 3, visible : null, animation : 'normal', 
        easing : 'swing', auto : 0, wrap : null, initCallback : null, reloadCallback : null, itemLoadCallback : null, 
        itemFirstInCallback : null, itemFirstOutCallback : null, itemLastInCallback : null, itemLastOutCallback : null, 
        itemVisibleInCallback : null, itemVisibleOutCallback : null, buttonNextHTML : '<div></div>', buttonPrevHTML : '<div></div>', 
        buttonNextEvent : 'click', buttonPrevEvent : 'click', buttonNextCallback : null, buttonPrevCallback : null
    };
    $.jcarousel = function (e, o)
    {
        ...
        if (a != '' && this.container.parent()[0].className.indexOf('jcarousel-skin') ==- 1) {
            this.container.wrap('<div class=" ' + a + '"></div>');
        }
    ...
    r.fn.extend(
    {
        ...
        has : function (i, a)
        {
            ...
            if (this.options.size !== null && a > this.options.size) {
                a = this.options.size;
            }
            for (var j = i; j <= a; j++)
            {
        ...
        add : function (i, s)
        {
            ...
            if (i > 0 && i < this.first) {
                this.list.css(this.lt, r.intval(this.list.css(this.lt)) - b + 'px');
            }
        ...
        remove : function (i)
        {
            ...
            if (i < this.first) {
                this.list.css(this.lt, r.intval(this.list.css(this.lt)) + d + 'px');
            }
            e.remove();
        ...
        animate : function (p, a)
        {
            ...
            var c = function ()
            {
                ...
                if (b.options.wrap == 'both' || b.options.wrap == 'last' || b.options.size == null || b.last < b.options.size) {
                    b.startAuto();
                }
                b.buttons();
        ...
        buttons : function (n, p)
        {
            ...
            var a = this;
            this.buttonNext[n ? 'bind' : 'unbind'](this.options.buttonNextEvent, this.funcNext)[n ? 'removeClass' : 'addClass'](this.className('jcarousel-next-disabled')).attr('disabled', 
            n ? false : true);
            this.buttonPrev[p ? 'bind' : 'unbind'](this.options.buttonPrevEvent, this.funcPrev)[p ? 'removeClass' : 'addClass'](this.className('jcarousel-prev-disabled')).attr('disabled', 
            p ? false : true);
        ...
        dimension : function (e, d)
        {
            ...
            var b = !this.options.vertical ? a.offsetWidth + r.margin(a, 'marginLeft') + r.margin(a, 'marginRight') : a.offsetHeight + r.margin(a, 
            'marginTop') + r.margin(a, 'marginBottom');
            if (d == undefined || b == d) {
                return b;
            }
            var w = !this.options.vertical ? d - r.margin(a, 'marginLeft') - r.margin(a, 'marginRight') : d - r.margin(a, 
            'marginTop') - r.margin(a, 'marginBottom');
            $(a).css(this.wh, w + 'px');
