(function($)
{
	$(document).ready(function()
	{
		...
		var uploader = new plupload.Uploader({
			...
			max_file_size: si_config_max_size+'mb',
			url: si_url_upload,
			multi_selection: false,
			flash_swf_url: si_plugin_path+'/plupload.flash.swf',
			silverlight_xap_url: si_plugin_path+'/plupload.silverlight.xap',
			filters: [ {title : "Files", extensions: si_config_extensions} ]
		});
